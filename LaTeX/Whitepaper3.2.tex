...
of the pool (see Figure \ref{fig: stakepledgebyclass}), and check
...
$0.185\%$ rather than $0.3\%$, as shown in Figure \ref{actual and simplified reserves}.
...
in Figure \ref{rewards and treasury} Thus the proportion between
...
\begin{figure}[!h]
\label{stakepledgesimple}\hspace{-0.7cm}\hspace{-0.7cm}\includegraphics{figures/rewardswithstakepledgesimple}\caption{\textbf{Rewards for different Stake and Pledge}. Stakes are represented
...
\begin{figure}[!h]
\label{fandp}\includegraphics[scale=0.98]{./figures/f_and_p.eps}\caption{\textbf{Reward adjustment f and p in practice }The chart shows $p$
...
\begin{figure}[!h]
\label{fig: average median pools}\includegraphics[scale=0.7]{figures/stakepledgemeanmedian}\caption{\textbf{Average and Median Stake and Pledge. }The figure covers the
period from epoch 311-470.}
\end{figure}

\textbf{Statistics}. We see in Figure \ref{fig: average median pools}
...
In Figure \eqref{fig: pools by stake} the upper chart shows how the
...
than saturation. 
\begin{figure}[!h]
\label{fig: pools by stake}\medskip{}
...
In Figure \ref{fig: pools by stake}, the lower chart shows how the
...
shown in the upper chart of Figure \ref{fig: stakepledgebyclass}.
The histogram corresponds to the following table:

%% TODO: This file is missing
%\hspace{-0.85cm}\includegraphics[scale=0.66]{./figures/pools_histogram_table.eps}
...
\ref{fig: stakepledgebyclass}, where it is compared to the $76.9\%%\ensuremath{=\frac{1}{1+a_{0}}}
...
\label{rewards and treasury}\hspace{-0.2cm}%
\begin{tabular}{cc}
\includegraphics[scale=0.46]{./figures/actualvssimplified_rewards_and_treasury.eps} & \includegraphics[scale=0.46]{./figures/actualvssimplified_trerew_ratio.eps}\tabularnewline
\end{tabular}\caption{\textbf{Actual vs Theoretical Rewards and Treasury}}
\end{figure}

Look at Figure \ref{rewards and treasury}. On the left we see that,
...
given in Figure \ref{rewards and treasury-1}, that breaks down the
...
\begin{figure}[H]
\label{rewards and treasury-1}\smallskip{}
...
reality. In Figure \ref{actual and simplified reserves}, left chart,
...
\begin{figure}[H]
\label{actual and simplified reserves}\medskip{}

\hspace{-0.2cm}%
\begin{tabular}{cc|}
\includegraphics[scale=0.47]{./figures/actual_and_simplified_reserves.eps} & \includegraphics[scale=0.47]{./figures/actualvssimplified_eta.eps}\tabularnewline
\end{tabular}\caption{\textbf{Actual Reserves vs Simplifications}}
\end{figure}
...
value, as we can see in the right chart of Figure \ref{actual and simplified reserves}. 
