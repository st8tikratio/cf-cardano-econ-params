...
parameters is given in \cite{webdocgeneral}. More insights are given
in \cite{Kant2020Delegation}. The derivation of part of the system
as a Nash equilibrium can be found in \cite{bruenjes2020rewardsharing}.
Related discussions can be found in \cite{cardano_cips,cardano_forum}.
...
\textbf{Desired number of pools}. Documentation in \cite{webdocgeneral},
...
\textbf{Pool Pledge Influence}. Documentation in \cite{webdocgeneral}
...
\label{deriv}%
\begin{tabular}{cc}
\includegraphics[width=7cm,height=5cm]{../figures/pledgederivative_sig0.01.eps} & \includegraphics[width=7cm,height=5cm]{../figures/pledgederivative_sig0.1.eps}\tabularnewline
\includegraphics[width=7cm,height=5cm]{../figures/pledgederivative_sig0.2.eps} & \includegraphics[width=7cm,height=5cm]{../figures/pledgederivative_sig0.5.eps}\tabularnewline
...
before paying them out as rewards. As \cite{webdocgeneral} says,
...
relative to the active stake ''. The more technical reference \cite{Kant2020Delegation}
...
by \cite{Kant2020Delegation} ``this nearly amounts to rewarding
...
in \cite{webdocgeneral} introduces Cardano monetary policy by describing
...
rigorous parameterization, as highlighted also in \cite{hoskinson2018ama}.
